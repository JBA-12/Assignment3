...
\solution\\
\text 1) As the widths of rectangles are not equal, we need to make certain modifications in the lengths of the rectangles so that the areas are proportional to the frequencies.\\

\text Here, \textbf{The minimum class-size = 2}\\\\
Let $l_i$ denote the length of rectangle of class interval i.\\
